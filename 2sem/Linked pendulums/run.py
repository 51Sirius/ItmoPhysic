...
def simulation():
    ...
    root = tk.Tk()
    root.title("LINKPEND")
    list_box_names = ["Масса", "Жесткость пружины", "Длина маятников", "Начальное отклонение №1",
                      "Начальное отклонение №2", "Положение пружины", "Время моделирования от",
                      "Время моделирования до", "Коэф затухания"]
    default_values = [
